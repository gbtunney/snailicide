...
import { ref,computed, defineComponent,PropType,Ref ,SetupContext,Prop,defineProps ,defineEmits,withDefaults} from 'vue';
...
export const useWindiCSSRuntimeDom = (_config = windicssRuntimeOptionsDefault) => {
