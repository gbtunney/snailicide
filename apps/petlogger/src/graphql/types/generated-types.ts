...
export type GProductQueryVariables = Exact<{ [key: string]: never; }>;


export type GProductQuery = { __typename?: 'Query', productsConnection: { __typename?: 'ProductConnection', edges: Array<{ __typename?: 'ProductEdge', node: { __typename?: 'Product', asin?: string | null, brand?: string | null, createdAt: any, description?: string | null, dimensions?: string | null, featureBullets: Array<string>, id: string, link?: string | null, purchase?: any | null, variantTitle?: string | null } }> } };

export type GAnimalQueryVariables = Exact<{ [key: string]: never; }>;


export type GAnimalQuery = { __typename?: 'Query', animals: Array<{ __typename?: 'Animal', born?: any | null, name?: string | null, sex: Sex, breeder?: { __typename?: 'Breeder', description?: string | null, email?: string | null, id: string, name?: string | null, publishedAt?: any | null } | null, photo?: { __typename?: 'Asset', createdAt: any, fileName: string, handle: string, height?: number | null, id: string, mimeType?: string | null, size?: number | null, updatedAt: any } | null }> };


export const GProductQueryDocument = gql`
    query GProductQuery {
  productsConnection {
    edges {
      node {
...
/**
 * __useGProductQuery__
 *
 * To run a query within a Vue component, call `useGProductQuery` and pass it any options that fit your needs.
 * When your component renders, `useGProductQuery` returns an object from Apollo Client that contains result, loading and error properties
 * you can use to render your UI.
 *
 * @param options that will be passed into the query, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/query.html#options;
 *
 * @example
 * const { result, loading, error } = useGProductQuery();
 */
export function useGProductQuery(options: VueApolloComposable.UseQueryOptions<GProductQuery, GProductQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GProductQuery, GProductQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GProductQuery, GProductQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<GProductQuery, GProductQueryVariables>(GProductQueryDocument, {}, options);
}
export function useGProductQueryLazyQuery(options: VueApolloComposable.UseQueryOptions<GProductQuery, GProductQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GProductQuery, GProductQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GProductQuery, GProductQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<GProductQuery, GProductQueryVariables>(GProductQueryDocument, {}, options);
}
export type GProductQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<GProductQuery, GProductQueryVariables>;
export const GAnimalQueryDocument = gql`
    query GAnimalQuery {
  animals {
    born
    name
 ...
 * __useGAnimalQuery__
 *
 * To run a query within a Vue component, call `useGAnimalQuery` and pass it any options that fit your needs.
 * When your component renders, `useGAnimalQuery` returns an object from Apollo Client that contains result, loading and error properties
 * you can use to render your UI.
 *
 * @param options that will be passed into the query, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/query.html#options;
 *
 * @example
 * const { result, loading, error } = useGAnimalQuery();
 */
export function useGAnimalQuery(options: VueApolloComposable.UseQueryOptions<GAnimalQuery, GAnimalQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GAnimalQuery, GAnimalQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GAnimalQuery, GAnimalQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<GAnimalQuery, GAnimalQueryVariables>(GAnimalQueryDocument, {}, options);
}
export function useGAnimalQueryLazyQuery(options: VueApolloComposable.UseQueryOptions<GAnimalQuery, GAnimalQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<GAnimalQuery, GAnimalQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<GAnimalQuery, GAnimalQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<GAnimalQuery, GAnimalQueryVariables>(GAnimalQueryDocument, {}, options);
}
export type GAnimalQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<GAnimalQuery, GAnimalQueryVariables>;