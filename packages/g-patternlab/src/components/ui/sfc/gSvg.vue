...
```jsx
<g-svg classes="p-2" width="40" color="orange" bg_color="indigo" border="orange" />
```

with path:

```jsx
<g-svg classes="p-2" path="leaves-a.svg" width="80" color="rebeccapurple" bg_color="orange" border="true"/>
```

with slot:

```jsx
<g-svg path="leaves-a.svg" width="80" color="rebeccapurple" >
