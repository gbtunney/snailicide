...
const props = withDefaults(
    defineProps<{
      ...
      variant_id: 5,//"Z2lkOi8vc2hvcGlmeS9Qcm9kdWN0VmFyaWFudC8yMjU4OTI4Mjc0NjQ4Ng==",//99//'Z2lkOi8vc2hvcGlmeS9Qcm9kdWN0VmFyaWFudC8yMjU4OTI4MzEwNjkzNA=='// '22620513665142'
...
const {Instance,isInstanceReady,SelectedVariant} = instanceRepo.init(props)
...
<template>
  <div class="product container">
    {{ isInstanceReady}}
    <div v-if="isInstanceReady"  class="bg-red-800 m-8">  instance :{{Instance}}
    <hr>
