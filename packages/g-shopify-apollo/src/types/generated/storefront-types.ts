...
export type Image = ShopifyProductNode & {
  __typename: 'Image';
 ...
 *
 */
export type ProductOption = Node & ShopifyNode & ShopifyProductNode & {
  ...
  name: Scalars['String'];
  option_values: Maybe<Array<Maybe<ProductOptionValue>>>;
  position: Maybe<Scalars['Int']>;
  product: Maybe<Product>;
...
export type ProductVariant = HasMetafields & Node & ShopifyNode & ShopifyProductNode & {
...
export type QueryRoot = {
  ...
  allVariants: Maybe<Array<Maybe<ProductVariant>>>;
  ...
  shop: Shop;
  testOption: Maybe<ProductOption>;
  testProduct: Maybe<Product>;
};
...
/** The schema’s entry-point for queries. This acts as the public, top-level API from which all queries must start. */
export type QueryRootTestOptionArgs = {
  index: Scalars['Int'];
};


/** The schema’s entry-point for queries. This acts as the public, top-level API from which all queries must start. */
export type QueryRootTestProductArgs = {
  index: Scalars['Int'];
};
...
export type VariantByIndexQuery = { __typename: 'QueryRoot', product: { __typename: 'Product', id: string, handle: string, variant: { __typename: 'ProductVariant', handle: string | null, title: string, quantityAvailable: number | null } | null, variants: { __typename: 'ProductVariantConnection', edges: Array<{ __typename: 'ProductVariantEdge', node: { __typename: 'ProductVariant', title: string } }> } } | null };
...
export type ProductOptionFragment = { __typename: 'ProductOption', id: string, values: Array<string>, title: string, handle: string };

export type ProductVariantFragment = { __typename: 'ProductVariant', id: string, title: string, weight: number | null, sku: string | null, currentlyNotInStock: boolean, requiresShipping: boolean, price: number, compareAtPrice: number | null, available: boolean, inventoryQuantity: number | null, product: { __typename: 'Product', id: string, title: string, options: Array<{ __typename: 'ProductOption', id: string, name: string, values: Array<string> }> }, image: { __typename: 'Image', id: string | null, width: number | null, height: number | null, src: string, alt: string | null } | null, selectedOptions: Array<{ __typename: 'SelectedOption', name: string, parent_handle: string, handle: string }>, priceV2: { __typename: 'MoneyV2', amount: number, currencyCode: CurrencyCode }, compareAtPriceV2: { __typename: 'MoneyV2', amount: number, currencyCode: CurrencyCode } | null, unitPrice: { __typename: 'MoneyV2', amount: number, currencyCode: CurrencyCode } | null, unitPriceMeasurement: { __typename: 'UnitPriceMeasurement', measuredType: UnitPriceMeasurementMeasuredType | null, quantityUnit: UnitPriceMeasurementMeasuredUnit | null, quantityValue: number, referenceUnit: UnitPriceMeasurementMeasuredUnit | null, referenceValue: number } | null };
...
export type ProductByHandleCustomQuery = { __typename: 'QueryRoot', product: { __typename: 'Product', id: string, handle: string, title: string, productType: string, vendor: string, tags: Array<string>, onlineStoreUrl: string | null, createdAt: Date, updatedAt: Date, publishedAt: Date, description: string, descriptionHtml: Element, available: boolean, compareAtPriceRange: { __typename: 'ProductPriceRange', minVariantPrice: { __typename: 'MoneyV2', amount: number, currencyCode: CurrencyCode }, maxVariantPrice: { __typename: 'MoneyV2', amount: number, currencyCode: CurrencyCode } }, priceRange: { __typename: 'ProductPriceRange', minVariantPrice: { __typename: 'MoneyV2', amount: number, currencyCode: CurrencyCode }, maxVariantPrice: { __typename: 'MoneyV2', amount: number, currencyCode: CurrencyCode } }, options: Array<{ __typename: 'ProductOption', id: string, values: Array<string>, title: string, handle: string }>, image: { __typename: 'Image', id: string | null, width: number | null, height: number | null, src: string, alt: string | null } | null, variants: { __typename: 'ProductVariantConnection', pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean }, edges: Array<{ __typename: 'ProductVariantEdge', cursor: string, node: { __typename: 'ProductVariant', id: string, title: string, weight: number | null, sku: string | null, currentlyNotInStock: boolean, requiresShipping: boolean, price: number, compareAtPrice: number | null, available: boolean, inventoryQuantity: number | null, product: { __typename: 'Product', id: string, title: string, options: Array<{ __typename: 'ProductOption', id: string, name: string, values: Array<string> }> }, image: { __typename: 'Image', id: string | null, width: number | null, height: number | null, src: string, alt: string | null } | null, selectedOptions: Array<{ __typename: 'SelectedOption', name: string, parent_handle: string, handle: string }>, priceV2: { __typename: 'MoneyV2', amount: number, currencyCode: CurrencyCode }, compareAtPriceV2: { __typename: 'MoneyV2', amount: number, currencyCode: CurrencyCode } | null, unitPrice: { __typename: 'MoneyV2', amount: number, currencyCode: CurrencyCode } | null, unitPriceMeasurement: { __typename: 'UnitPriceMeasurement', measuredType: UnitPriceMeasurementMeasuredType | null, quantityUnit: UnitPriceMeasurementMeasuredUnit | null, quantityValue: number, referenceUnit: UnitPriceMeasurementMeasuredUnit | null, referenceValue: number } | null } }> }, images: { __typename: 'ImageConnection', pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean }, edges: Array<{ __typename: 'ImageEdge', cursor: string, node: { __typename: 'Image', id: string | null, width: number | null, height: number | null, src: string, alt: string | null } }> } } | null };
...
export type ProductByIdQuery = { __typename: 'QueryRoot', product: { __typename: 'Product', id: string, handle: string, title: string, productType: string, vendor: string, tags: Array<string>, onlineStoreUrl: string | null, createdAt: Date, updatedAt: Date, publishedAt: Date, description: string, descriptionHtml: Element, available: boolean, compareAtPriceRange: { __typename: 'ProductPriceRange', minVariantPrice: { __typename: 'MoneyV2', amount: number, currencyCode: CurrencyCode }, maxVariantPrice: { __typename: 'MoneyV2', amount: number, currencyCode: CurrencyCode } }, priceRange: { __typename: 'ProductPriceRange', minVariantPrice: { __typename: 'MoneyV2', amount: number, currencyCode: CurrencyCode }, maxVariantPrice: { __typename: 'MoneyV2', amount: number, currencyCode: CurrencyCode } }, options: Array<{ __typename: 'ProductOption', id: string, values: Array<string>, title: string, handle: string }>, image: { __typename: 'Image', id: string | null, width: number | null, height: number | null, src: string, alt: string | null } | null, variants: { __typename: 'ProductVariantConnection', pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean }, edges: Array<{ __typename: 'ProductVariantEdge', cursor: string, node: { __typename: 'ProductVariant', id: string, title: string, weight: number | null, sku: string | null, currentlyNotInStock: boolean, requiresShipping: boolean, price: number, compareAtPrice: number | null, available: boolean, inventoryQuantity: number | null, product: { __typename: 'Product', id: string, title: string, options: Array<{ __typename: 'ProductOption', id: string, name: string, values: Array<string> }> }, image: { __typename: 'Image', id: string | null, width: number | null, height: number | null, src: string, alt: string | null } | null, selectedOptions: Array<{ __typename: 'SelectedOption', name: string, parent_handle: string, handle: string }>, priceV2: { __typename: 'MoneyV2', amount: number, currencyCode: CurrencyCode }, compareAtPriceV2: { __typename: 'MoneyV2', amount: number, currencyCode: CurrencyCode } | null, unitPrice: { __typename: 'MoneyV2', amount: number, currencyCode: CurrencyCode } | null, unitPriceMeasurement: { __typename: 'UnitPriceMeasurement', measuredType: UnitPriceMeasurementMeasuredType | null, quantityUnit: UnitPriceMeasurementMeasuredUnit | null, quantityValue: number, referenceUnit: UnitPriceMeasurementMeasuredUnit | null, referenceValue: number } | null } }> }, images: { __typename: 'ImageConnection', pageInfo: { __typename: 'PageInfo', hasNextPage: boolean, hasPreviousPage: boolean }, edges: Array<{ __typename: 'ImageEdge', cursor: string, node: { __typename: 'Image', id: string | null, width: number | null, height: number | null, src: string, alt: string | null } }> } } | null };
...
export type ShopQuery = { __typename: 'QueryRoot', shop: { __typename: 'Shop', description: string | null, moneyFormat: string, name: string, paymentSettings: { __typename: 'PaymentSettings', enabledPresentmentCurrencies: Array<CurrencyCode> }, primaryDomain: { __typename: 'Domain', host: string, sslEnabled: boolean, url: string } } };
...
/**
 * __useTestproductopQuery__
 *
 * To run a query within a Vue component, call `useTestproductopQuery` and pass it any options that fit your needs.
 * When your component renders, `useTestproductopQuery` returns an object from Apollo Client that contains result, loading and error properties
 * you can use to render your UI.
 *
 * @param options that will be passed into the query, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/query.html#options;
 *
 * @example
 * const { result, loading, error } = useTestproductopQuery();
 */
export function useTestproductopQuery(options: VueApolloComposable.UseQueryOptions<TestproductopQuery, TestproductopQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<TestproductopQuery, TestproductopQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<TestproductopQuery, TestproductopQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<TestproductopQuery, TestproductopQueryVariables>(TestproductopDocument, {}, options);
}
export function useTestproductopLazyQuery(options: VueApolloComposable.UseQueryOptions<TestproductopQuery, TestproductopQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<TestproductopQuery, TestproductopQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<TestproductopQuery, TestproductopQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<TestproductopQuery, TestproductopQueryVariables>(TestproductopDocument, {}, options);
}
export type TestproductopQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<TestproductopQuery, TestproductopQueryVariables>;
export const PossibleNodesDocument = gql`
 ...
 *
 * To run a query within a Vue component, call `usePossibleNodesQuery` and pass it any options that fit your needs.
 * When your component renders, `usePossibleNodesQuery` returns an object from Apollo Client that contains result, loading and error properties
 * you can use to render your UI.
 *
 ...
 *
 * @example
 * const { result, loading, error } = usePossibleNodesQuery({
 *   id: // value for 'id'
 * });
 */
export function usePossibleNodesQuery(variables: PossibleNodesQueryVariables | VueCompositionApi.Ref<PossibleNodesQueryVariables> | ReactiveFunction<PossibleNodesQueryVariables>, options: VueApolloComposable.UseQueryOptions<PossibleNodesQuery, PossibleNodesQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<PossibleNodesQuery, PossibleNodesQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<PossibleNodesQuery, PossibleNodesQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<PossibleNodesQuery, PossibleNodesQueryVariables>(PossibleNodesDocument, variables, options);
}
export function usePossibleNodesLazyQuery(variables: PossibleNodesQueryVariables | VueCompositionApi.Ref<PossibleNodesQueryVariables> | ReactiveFunction<PossibleNodesQueryVariables>, options: VueApolloComposable.UseQueryOptions<PossibleNodesQuery, PossibleNodesQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<PossibleNodesQuery, PossibleNodesQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<PossibleNodesQuery, PossibleNodesQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<PossibleNodesQuery, PossibleNodesQueryVariables>(PossibleNodesDocument, variables, options);
}
 ...
 *
 * To run a query within a Vue component, call `useProductByHandleCustomQuery` and pass it any options that fit your needs.
 * When your component renders, `useProductByHandleCustomQuery` returns an object from Apollo Client that contains result, loading and error properties
 * you can use to render your UI.
 *
 * @param variables that will be passed into the query
 * @param options that will be passed into the query, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/query.html#options;
 *
 * @example
 * const { result, loading, error } = useProductByHandleCustomQuery({
 *   handle: // value for 'handle'
 * });
 */
export function useProductByHandleCustomQuery(variables: ProductByHandleCustomQueryVariables | VueCompositionApi.Ref<ProductByHandleCustomQueryVariables> | ReactiveFunction<ProductByHandleCustomQueryVariables>, options: VueApolloComposable.UseQueryOptions<ProductByHandleCustomQuery, ProductByHandleCustomQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<ProductByHandleCustomQuery, ProductByHandleCustomQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<ProductByHandleCustomQuery, ProductByHandleCustomQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<ProductByHandleCustomQuery, ProductByHandleCustomQueryVariables>(ProductByHandleCustomDocument, variables, options);
}
export function useProductByHandleCustomLazyQuery(variables: ProductByHandleCustomQueryVariables | VueCompositionApi.Ref<ProductByHandleCustomQueryVariables> | ReactiveFunction<ProductByHandleCustomQueryVariables>, options: VueApolloComposable.UseQueryOptions<ProductByHandleCustomQuery, ProductByHandleCustomQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<ProductByHandleCustomQuery, ProductByHandleCustomQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<ProductByHandleCustomQuery, ProductByHandleCustomQueryVariables>> = {}) {
 ...
 *
 * To run a query within a Vue component, call `useProductByIdQuery` and pass it any options that fit your needs.
 * When your component renders, `useProductByIdQuery` returns an object from Apollo Client that contains result, loading and error properties
 * you can use to render your UI.
 *
 * @param variables that will be passed into the query
 * @param options that will be passed into the query, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/query.html#options;
 *
 * @example
 * const { result, loading, error } = useProductByIdQuery({
 *   id: // value for 'id'
 * });
 */
export function useProductByIdQuery(variables: ProductByIdQueryVariables | VueCompositionApi.Ref<ProductByIdQueryVariables> | ReactiveFunction<ProductByIdQueryVariables>, options: VueApolloComposable.UseQueryOptions<ProductByIdQuery, ProductByIdQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<ProductByIdQuery, ProductByIdQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<ProductByIdQuery, ProductByIdQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<ProductByIdQuery, ProductByIdQueryVariables>(ProductByIdDocument, variables, options);
}
export function useProductByIdLazyQuery(variables: ProductByIdQueryVariables | VueCompositionApi.Ref<ProductByIdQueryVariables> | ReactiveFunction<ProductByIdQueryVariables>, options: VueApolloComposable.UseQueryOptions<ProductByIdQuery, ProductByIdQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<ProductByIdQuery, ProductByIdQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<ProductByIdQuery, ProductByIdQueryVariables>> = {}) {
...
/**
 * __useVariantBySelectedOptionsQuery__
 *
 * To run a query within a Vue component, call `useVariantBySelectedOptionsQuery` and pass it any options that fit your needs.
 * When your component renders, `useVariantBySelectedOptionsQuery` returns an object from Apollo Client that contains result, loading and error properties
 * you can use to render your UI.
 *
 * @param variables that will be passed into the query
 * @param options that will be passed into the query, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/query.html#options;
 *
 * @example
 * const { result, loading, error } = useVariantBySelectedOptionsQuery({
 *   handle: // value for 'handle'
 *   selectedOptions: // value for 'selectedOptions'
 * });
 */
export function useVariantBySelectedOptionsQuery(variables: VariantBySelectedOptionsQueryVariables | VueCompositionApi.Ref<VariantBySelectedOptionsQueryVariables> | ReactiveFunction<VariantBySelectedOptionsQueryVariables>, options: VueApolloComposable.UseQueryOptions<VariantBySelectedOptionsQuery, VariantBySelectedOptionsQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<VariantBySelectedOptionsQuery, VariantBySelectedOptionsQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<VariantBySelectedOptionsQuery, VariantBySelectedOptionsQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<VariantBySelectedOptionsQuery, VariantBySelectedOptionsQueryVariables>(VariantBySelectedOptionsDocument, variables, options);
}
export function useVariantBySelectedOptionsLazyQuery(variables: VariantBySelectedOptionsQueryVariables | VueCompositionApi.Ref<VariantBySelectedOptionsQueryVariables> | ReactiveFunction<VariantBySelectedOptionsQueryVariables>, options: VueApolloComposable.UseQueryOptions<VariantBySelectedOptionsQuery, VariantBySelectedOptionsQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<VariantBySelectedOptionsQuery, VariantBySelectedOptionsQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<VariantBySelectedOptionsQuery, VariantBySelectedOptionsQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<VariantBySelectedOptionsQuery, VariantBySelectedOptionsQueryVariables>(VariantBySelectedOptionsDocument, variables, options);
}
export type VariantBySelectedOptionsQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<VariantBySelectedOptionsQuery, VariantBySelectedOptionsQueryVariables>;
 ...
 * __useShopQuery__
 *
 * To run a query within a Vue component, call `useShopQuery` and pass it any options that fit your needs.
 * When your component renders, `useShopQuery` returns an object from Apollo Client that contains result, loading and error properties
 * you can use to render your UI.
 *
 * @param options that will be passed into the query, supported options are listed on: https://v4.apollo.vuejs.org/guide-composable/query.html#options;
 *
 * @example
 * const { result, loading, error } = useShopQuery();
 */
export function useShopQuery(options: VueApolloComposable.UseQueryOptions<ShopQuery, ShopQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<ShopQuery, ShopQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<ShopQuery, ShopQueryVariables>> = {}) {
  return VueApolloComposable.useQuery<ShopQuery, ShopQueryVariables>(ShopDocument, {}, options);
}
export function useShopLazyQuery(options: VueApolloComposable.UseQueryOptions<ShopQuery, ShopQueryVariables> | VueCompositionApi.Ref<VueApolloComposable.UseQueryOptions<ShopQuery, ShopQueryVariables>> | ReactiveFunction<VueApolloComposable.UseQueryOptions<ShopQuery, ShopQueryVariables>> = {}) {
  return VueApolloComposable.useLazyQuery<ShopQuery, ShopQueryVariables>(ShopDocument, {}, options);
}
export type ShopQueryCompositionFunctionResult = VueApolloComposable.UseQueryReturn<ShopQuery, ShopQueryVariables>;