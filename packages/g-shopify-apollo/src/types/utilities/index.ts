...
import type {Primitive,LiteralToPrimitive} from 'type-fest';
...
export const tg_isPrimitive = <T = unknown>(value: T | Primitive): value is Primitive =>
    RA.isPrimitive(value)
export const tg_isNotPrimitive = <T = unknown>(value: T | Primitive): value is T =>
