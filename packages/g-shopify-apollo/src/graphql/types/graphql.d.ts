...
export type ProductOptionFragmentFragment = { __typename?: 'ProductOption', id: string, values: Array<string>, type: 'ProductOption', gid: string, sid: string, title: string, handle: string };
